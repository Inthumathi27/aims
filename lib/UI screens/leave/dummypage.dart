...
class LeaveSummary1 extends StatefulWidget {
  @override
  _LeaveSummary1State createState() => _LeaveSummary1State();
}

class _LeaveSummary1State extends State<LeaveSummary1> {
                                            ...
                                            DataCell(
                                              InkWell(
                                                onTap: (){
                                                  // showDialog(
                                                  //   context: context,
                                                  //   builder: (BuildContext context) => _casualLeaveDialog(context),
                                                  // );
                                                },
  ...
  Widget _casualLeaveDialog(BuildContext context) {
    return  AlertDialog(
      title: SmallText(text: MyStrings.casualLeave),
      content:  Column(
